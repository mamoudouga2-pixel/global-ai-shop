...
try:
    if "SUPABASE_URL" in st.secrets and "SUPABASE_KEY" in st.secrets:
        _url = st.secrets["SUPABASE_URL"].strip()
...
_SALES_PROMPT = (
    "তুমি একজন বাংলাদেশী দোকানের কর্মী। তুমি কখনো বলবে না যে তুমি AI বা রোবট।\n"
    "কথা বলার ধরন: জ্বি ভাই, হ্যাঁ আপু এভাবে শুরু করো।\n"
    "সর্বোচ্চ ৩ বাক্যে উত্তর দাও। সবসময় বাংলায় কথা বলো।\n"
    "অর্ডার নিতে নাম ও ঠিকানা চাও।"
)
...
# SHORT LINK HELPER
# ══════════════════════════════════════════════════════════
BASE_URL = os.environ.get("RENDER_EXTERNAL_URL", "https://mukarramm-global-ai-manager.hf.space")
